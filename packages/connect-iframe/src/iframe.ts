...
import { CORE_EVENT, UI_EVENT, DEVICE_EVENT, TRANSPORT_EVENT } from 'trezor-connect/lib/constants';
import * as POPUP from 'trezor-connect/lib/constants/popup';
import * as IFRAME from 'trezor-connect/lib/constants/iframe';
import * as UI from 'trezor-connect/lib/constants/ui';
...
import { parseMessage } from 'trezor-connect/lib/message';
import { UiMessage, ResponseMessage } from 'trezor-connect/lib/message/builder';

// import type { CoreMessage, PostMessageEvent } from 'trezor-connect/lib/typescript';
...
} from 'trezor-connect/lib/env/browser/browserUtils';
import { load as loadStorage, PERMISSIONS_KEY } from 'trezor-connect/lib/storage';
...
const postMessage = (message: CoreMessage) => {
    ...
    if (usingPopup && targetUiEvent(message)) {
        ...
        let origin: string | undefined = DataManager.getSettings('origin');
